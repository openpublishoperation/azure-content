...
3. **[Creating a HR2day by Merces test user](#creating-a-hr2day-by-merces-test-user.md)** - to have a counterpart of Britta Simon in HR2day by Merces that is linked to the Azure AD representation of her.
