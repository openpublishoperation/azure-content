...
* If that looks correct, follow the steps in [Verify proxy connectivity](#verify-proxy-connectivity.md) to see if the issue is present outside the wizard as well.
