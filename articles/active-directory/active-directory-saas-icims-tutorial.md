...
3. **[Creating a ICIMS test user](#creating-a-icims-test-user.md)** - to have a counterpart of Britta Simon in ICIMS that is linked to the Azure AD representation of her.
