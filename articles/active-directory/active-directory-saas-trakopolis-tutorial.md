...
3. **[Creating a Trakopolis test user](#creating-a-trakopolis-test-user.md)** - to have a counterpart of Britta Simon in Trakopolis that is linked to the Azure AD representation of her.
