...
* Open the `web.config` file in the root of the `TodoList-WebApp` project, and enter your app's configuration values in the `<appSettings>` section.  * The `ida:ClientId` is the **Application Id** assigned to your app in the registration portal.
