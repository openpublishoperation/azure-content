...
3. **[Creating a HPE SaaS test user](#creating-a-hpesaas-test-user.md)** - to have a counterpart of Britta Simon in HPE SaaS that is linked to the Azure AD representation of her.
